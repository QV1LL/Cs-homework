        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudiosId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CitiesStudios", x => new { x.CitiesId, x.StudiosId });
                    table.ForeignKey(
                        name: "FK_CitiesStudios_Cities_CitiesId",
                        column: x => x.CitiesId,
                        principalTable: "Cities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CitiesStudios_Studios_StudiosId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CitiesStudios_StudiosId",
                table: "CitiesStudios",
                column: "StudiosId");
