...
internal interface IMessageService
{
    ...
    Task<Result<Models.Message>> CreateAsync(Models.Message message, Guid chatId);
    Task<Result<Models.Message>> UpdateAsync(Models.Message message);
    Task<bool> DeleteAsync(Guid id);

    Task<Result<IEnumerable<Models.Message>>> GetRecentAsync(int count, Guid chatId);
    Task<Result<IEnumerable<Models.Message>>> GetOlderAsync(DateTimeOffset before, int count, Guid chatId);
}
